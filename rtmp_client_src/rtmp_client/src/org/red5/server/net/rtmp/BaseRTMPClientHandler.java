...
public abstract class BaseRTMPClientHandler extends BaseRTMPHandler {
	...
	public IPendingServiceCallback connectCallback;
	...
	/* Commented :: CatturaVideo
		   This change has been made to introduce the authentication by User Name & Password*/
	public Map<String, Object> makeDefaultConnectionParams(String server, int port, String application) {
		...
		params.put("swfUrl", String.format("rtmp://%s:%s/%s", server, port, application));
	...
	public void connect(String server, int port, Map<String, Object> connectionParams, IPendingServiceCallback connectCallback, Object[] connectCallArguments) {
		...
		/* Commented :: CatturaVideo
		   objectEncoding is not part of Connection Parameters */
	...
	@Override
	protected void caughtExceptions(RTMPConnection conn,Throwable cause)
	{
...
//		log.debug("publishStreamData - stream data map: {}",	streamDataMap);
	...
	/* Commented :: CatturaVideo
	   Set the authentication as false (default) */
